1. Objetivo:
Criar uma API Rest para gerenciar um caderno digital de receitas saudáveis chamado StarHealthyBook.
...
Nível de Preparo: Fácil, Médio, Difícil.
Custo: $, $$, $$$.
Cada receita pertence a uma categoria, mas pode ter várias tags informando se é uma receita: "sem glúten", "vegana", "Sem açúcar","sem lactose" e etc.
...
A API deve permitir filtros múltiplos.
